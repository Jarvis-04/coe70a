...
# while(1):
#     print(robot.color_1.reflection())
#     wait(500)
...
# while(1):
#     Movement.setSpeed(robot, 150)
#     print(Movement.hexagonFollower2016(robot))
#     Movement.forwardMovement(robot, 50)
...
# Lift.seniorClaw2016(robot, "lift")
# Lift.setHolderPosition(robot, 1, "turn")
# wait(500)
# Lift.seniorClaw2016(robot, "press")
# Lift.seniorClaw2016(robot, "lift")
# Lift.setHolderPosition(robot, 1, "turn")
